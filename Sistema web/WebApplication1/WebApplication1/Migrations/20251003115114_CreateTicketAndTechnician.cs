...
{
    /// <inheritdoc />
    public partial class CreateTicketAndTechnician : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadedTo = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Technicians", x => x.Id_Tecnico);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Aberto"),
                    Tecnico = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "A definir")
                },
                constraints: table =>
                {
